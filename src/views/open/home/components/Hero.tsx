...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-[92vh] flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container px-4 lg:px-6 text-white">
        <div className="max-w-4xl animate-fade-in">
          <h1 className="font-playfair text-white text-4xl md:text-6xl font-bold mb-6 leading-tight">
            Welcome to <span className="text-white">Vans Cafe</span>
          </h1>
          <p className="text-sm md:text-2xl mb-8 text-warm-white/90 max-w-2xl">
      ...
      <div className="absolute hidden sm:block bottom-8 left-1/2 transform -translate-x-1/2 text-white animate-bounce">
        <div className="w-4 h-6 border-1 border-white rounded-full flex justify-center">
